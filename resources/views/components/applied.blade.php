<div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <h3>Facualty of Pure Applied Sciences</h3>
                <form id="agriculture-suggest-form" action="{{ url('suggestions') }}" method="post">
                    ...
                    <select class="form-control form-control-sm" name="college" id="">
                        <option value="School physical sciences">
                            School physical sciences
                        </option>
                        <option value="School of Biological sciences">
                            School of Biological sciences
                        </option>
                        <option value="School of mathematical Sciences">
                            School of mathematical Sciences
                        </option>
                        <option value="School of computing with IT">
                                School of computing with IT
                        </option>
                    </select>
                    </div>
    ...
    <script>
            $('form#agriculture-suggest-form').submit(function(event){
                ...
                if (errors.length == 0) {
                    ...
                    {
                        _token : data[0].value,
                        college : 'Facualty of Pure Applied Sciences',
                        school : data[1].value,
                        title : data[2].value,
