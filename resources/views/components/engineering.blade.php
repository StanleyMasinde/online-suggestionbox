            ...
            <div class="card-body">
                ...
                <form id="agriculture-suggest-form" action="{{ url('suggestions') }}" method="post">
                    ...
                    <select class="form-control form-control-sm" name="college" id="">
                        <option value="School of architecture and building sciences">
                            School of architecture and building sciences
                        </option>
                        <option value="School of electrical, electronic and information engineering">
                            School of electrical, electronic and information engineering
                        </option>
                        <option value="School of electrical, electronic and information engineering">
                           School of electrical, electronic and information engineering
                        </option>
                        <option value="School of civil, environmental and geospatial engineering">
                               School of civil, environmental and geospatial engineering
                        </option>
                        <option value="School of biosystems and environmental engineering">
                               School of biosystems and environmental engineering
                        </option>
                        <option value="School of Sustainable materials, research and technology">
                                School of Sustainable materials, research and technology
                        </option>
                    </select>
                    </div>
    ...
    <script>
            $('form#agriculture-suggest-form').submit(function(event){
                ...
                if (errors.length == 0) {
                    ...
                    {
                        _token : data[0].value,
                        college : 'Facualty of Engineering',
                        school : data[1].value,
                        title : data[2].value,
