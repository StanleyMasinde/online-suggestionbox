        ...
        <div class="card-body">
            ...
            <form id="agriculture-suggest-form" action="{{ url('suggestions') }}" method="post">
                ...
                <select class="form-control form-control-sm" name="college" id="">
                    <option value="School of Agriculture and environmental studies">
                        School of Agriculture and environmental studies
                    </option>
                    <option value="School of Food and nutrition Sciences">
                        School of Food and nutrition Sciences
                    </option>
                    <option value="School of Natural Resources And animal Sciences">
...
<script>
    $('form#agriculture-suggest-form').submit(function(event){
        ...
        if (errors.length == 0) {
            ...
            {
                _token : data[0].value,
                college : 'Facualty of Agricultre',
                school : data[1].value,
                title : data[2].value,
